...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col font-display bg-background-light dark:bg-background-dark text-text-light-primary dark:text-text-dark-primary overflow-x-hidden">
      ...
      <main className="flex flex-1 justify-center py-5 sm:py-8 lg:py-10 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col w-full max-w-4xl flex-1 gap-6 sm:gap-8">
          
          {/* Profile Header Card */}
          <section className="flex flex-col gap-6 p-4 sm:p-6 bg-white dark:bg-card-dark rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              
              {/* Professional Avatar & Info */}
              <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6">
                <div
                  className="bg-center bg-no-repeat aspect-square bg-cover rounded-full h-24 w-24 sm:h-28 sm:w-28 lg:h-32 lg:w-32 flex-shrink-0 shadow-md ring-4 ring-primary/10"
                ...
                <div className="flex flex-col justify-center min-w-0">
                  <h1 className="text-gray-900 dark:text-white text-xl sm:text-2xl lg:text-3xl font-bold leading-tight tracking-tight break-words">
                    Júlio César
                  </h1>
                  <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base font-normal mt-0.5">
              ...
              {/* Action Buttons */}
              <div className="flex flex-col gap-2.5 w-full lg:w-auto lg:min-w-[300px]">
                {/* Primary Actions */}
                <div className="flex flex-col sm:flex-row gap-2.5 w-full">
                  <button
                    type="button"
                    onClick={() => window.location.href = 'tel:+5511988887777'}
                    className="flex w-full sm:flex-1 min-h-[48px] cursor-pointer items-center justify-center rounded-xl px-5 bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white text-sm font-bold leading-normal hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  ...
                  <button
                    ...
                    className="flex w-full sm:flex-1 min-h-[48px] cursor-pointer items-center justify-center rounded-xl px-5 bg-primary text-white text-sm font-bold leading-normal hover:bg-primary/90 transition-colors shadow-sm gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                ...
                <div className="flex gap-2.5 w-full">
                  <button
                    type="button"
                    onClick={handleShare}
                    className="flex flex-1 min-h-[44px] cursor-pointer items-center justify-center rounded-xl px-4 bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 text-xs sm:text-sm font-semibold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  ...
                  <button
                    ...
                    className="flex flex-1 min-h-[44px] cursor-pointer items-center justify-center rounded-xl px-4 bg-slate-100 dark:bg-slate-800 text-slate-800 dark:text-slate-200 text-xs sm:text-sm font-semibold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors gap-2 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          ...
          >
            {[
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 sm:px-6 py-3.5 min-h-[48px] text-xs sm:text-sm font-bold leading-normal tracking-wide transition-colors whitespace-nowrap border-b-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
                  activeTab === tab.id
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Basic Info Tab */}
            {activeTab === 'basicinfo' && (
              <div className="flex flex-col gap-6 sm:gap-8 animate-in fade-in slide-in-from-bottom-3 duration-300">
                {/* About Description */}
                <section className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                  <h2 className="text-gray-900 dark:text-white text-lg sm:text-xl font-bold tracking-tight mb-3">
                    Sobre o Profissional
                  </h2>
                  <p className="text-slate-600 dark:text-slate-400 text-sm sm:text-base font-normal leading-relaxed break-words">
                ...
                {/* Services Provided */}
                <section className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                  <h2 className="text-gray-900 dark:text-white text-lg sm:text-xl font-bold tracking-tight mb-4">
                    Serviços Oferecidos
                  </h2>
                  <div className="flex flex-wrap gap-2 sm:gap-2.5">
                    {['Instalação Elétrica', 'Manutenção Predial', 'Reparos Rápidos', 'Quadros de Energia', 'Iluminação LED', 'Automação'].map((service, i) => (
                      <span
                        key={i}
                        className="px-3.5 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 rounded-full text-xs sm:text-sm font-semibold"
                      >
                        {service}
                      </span>
                    ))}
                ...
                <section className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                    <a
                      ...
                      className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-slate-700 dark:text-slate-300 hover:text-pink-600 dark:hover:text-pink-400 hover:border-pink-300 transition-all cursor-pointer group flex-1"
                    >
                      ...
                      <span className="text-xs sm:text-sm font-medium truncate">@juliocesar.eletricista</span>
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-blue-400 hover:border-blue-300 transition-all cursor-pointer group flex-1"
                    >
                      <svg className="w-5 h-5 shrink-0 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                      </svg>
                      <span className="text-xs sm:text-sm font-medium truncate">Júlio César Eletricista</span>
                    </a>
                  </div>
                </section>
                ...
                <section className="bg-white dark:bg-card-dark p-5 sm:p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block w-full h-44 sm:h-48 md:h-56 bg-center bg-no-repeat bg-cover rounded-xl overflow-hidden cursor-pointer hover:opacity-90 hover:shadow-lg transition-all group relative border border-gray-200 dark:border-gray-700"
                    style={{
                      backgroundImage:
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-xs sm:text-sm mt-3 flex items-center gap-1.5">
            ...
            {/* Reviews Tab */}
            {activeTab === 'reviews' && (
              <div className="flex flex-col gap-3.5 sm:gap-4 animate-in fade-in slide-in-from-bottom-3 duration-300">
                <div className="p-4 sm:p-5 border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-card-dark shadow-sm">
                  ...
                  <p className="text-slate-900 dark:text-slate-300 text-xs sm:text-sm font-bold mt-2.5">- Mariana Silva</p>
                </div>
                ...
                <div className="p-4 sm:p-5 border border-slate-200 dark:border-slate-800 rounded-xl bg-white dark:bg-card-dark shadow-sm">
                  ...
                  <p className="text-slate-900 dark:text-slate-300 text-xs sm:text-sm font-bold mt-2.5">- Roberto Costa</p>
                </div>
              </div>
            )}
